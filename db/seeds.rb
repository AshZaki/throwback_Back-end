...
facebook = Social.create(name:"facebook")
instagram = Social.create(name:"Instagram")
twitter = Social.create(name:"Twitter")

board1 = Board.create(user_id: 1, name:"DIY", description:"hey")